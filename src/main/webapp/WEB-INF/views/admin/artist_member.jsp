...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">아티스트멤버 목록</h1>
			...
			<div class="panel-body">
				...
				<div class='row'>
					<div class="col-lg-12">
						...
						<form id='searchForm' action="/admin/artist_member" method='get'>
							<select name='type'>
								<option value=""
				...
				<!-- 페이징 Form 시작 -->
				<form id='actionForm' action="/admin/artist_member" method='get'>
			...
			.ready(
					function() {
						...
						$("#regBtn").on("click", function() {
							self.location = "/admin/artist_member_register";
						});
						-->
