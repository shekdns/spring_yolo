...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">아티스트 목록</h1>
			...
			<div class="panel-body">
				<table class="table table-striped table-bordered table-hover">
					...
					<c:forEach items="${artist}" var="artist">
						<tr>
							...
							<td align="center"><a href="/resources/upload/${artist.artist_img_path}" target="_blank">
							<img src="/resources/upload/${artist.artist_img_path}" height='50' width="50"></a></td>
							</c:if>
							...
							<td><a class='move' href='<c:out value="${artist.artist_idx}"/>'><c:out value="${artist.artist_name}" /></a></td>
							<td><c:out value="${artist.debut}" /></td>
							<td><c:out value="${artist.artist_type}" /></td>
							<td><c:out value="${artist.gender}" /></td>
						</tr>
						  <script>
                 		   document.getElementById('thumb_').src="/resources/upload/" + getThumbFileName('${artist_img_path}');
               			  </script>
					</c:forEach>
				...
				<div class='row'>
					<div class="col-lg-12">
						...
						<form id='searchForm' action="/admin/artist" method='get'>
							<select name='type'>
								<option value=""
								...
								<option value="W"
									<c:out value="${pageMaker.cri.type eq 'W'?'selected':''}"/>>성별</option>
								<option value="TC"
				...
				<!-- 페이징 Form 시작 -->
				<form id='actionForm' action="/admin/artist" method='get'>
			...
			.ready(
					function() {
						...
						$("#regBtn").on("click", function() {
							self.location = "/admin/artist_register";
						});
						-->
