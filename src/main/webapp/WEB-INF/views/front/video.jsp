...
<div id="content-page" class="content-page">
	<div class="container-fluid">
				...
				<div class="iq-card">
					<div class="iq-card-header d-flex justify-content-between">
						<div class="iq-header-title">
							<h4 class="card-title">YOLO 영상</h4>
						</div>
					...
					<div class="iq-card-body">
						...
						<ul class="list-unstyled row iq-box-hover mb-0">
							...
							<c:forEach items="${song}" var="song">
								<li class="col-md-4 iq-music-box">
									<div class="iq-card">
										<div class="iq-card mb-lg-4">
											<div class="iq-thumb">
												

												<iframe width="500" height="300" src="${song.song_video}"
													frameborder="0"
											...
											<div class="feature-list text-center">
												<h6 class="font-weight-600 mb-0">
													<a class='move' href='<c:out value="${song.song_idx}"/>'>
														<c:out value="${song.song_name}" />
													</a>
												</h6>
												<p class="mb-0">
													<a class='move2' href='<c:out value="${song.artist_idx}"/>'>
		...
		<!-- 페이징 Form 시작 -->
		<form id='actionForm' action="/front/video" method='get'>
		...
		<form id='actionForm2' action="/front/video" method='get'>
			<input type='hidden' name='pageNum' value='${pageMaker.cri.pageNum}'>
			<input type='hidden' name='amount' value='${pageMaker.cri.amount}'>
			<input type='hidden' name='type'
				value='<c:out value="${ pageMaker.cri.type }"/>'> <input
